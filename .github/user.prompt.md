...
{final_output_file} = /.github/context-user/user-instructions.md
...
6. All output must be in `/.github/context-user` folder, For each step, output results into a corresponding `.github/context-user/{output_folder}/` folder.
    - Mirror the step’s filename e.g., `1-determine-techstack.md` > `.github/context-user/{output_folder}/1-determine-techstack.md`.
Stop ONLY when:
