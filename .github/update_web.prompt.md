{output_folder} = .web-results

{final_output_file} = /.github/context-web/web-instructions.md.

{new_features_updates_dir} = /.github/context-web/
...
7. make changes ONLY to prompt files and sections that needs it based on the new features/updates made in {target}. If a section is not affected by the new features/updates, do not modify it.
