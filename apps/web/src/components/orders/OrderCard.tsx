  ...
  return (
    <div className="card">
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-4 pb-4 border-b">
        <div>
          <p className="text-sm text-muted mb-1">
            Order Placed: <span className="font-semibold text-gray-900">{format(new Date(order.createdAt), "MMM d, yyyy")}</span>
          </p>
      ...
      <div className="flex gap-4">
        {/* Placeholder for order item image, assuming single item for now */}
        <div className="h-20 w-20 rounded bg-gray-100 flex-shrink-0 flex items-center justify-center text-gray-400">
          <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
          </svg>
        </div>
        <div className="flex-1">
          <h4 className="font-semibold text-gray-900">Custom Tailored Garment</h4>
